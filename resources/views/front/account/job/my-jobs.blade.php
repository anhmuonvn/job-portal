            ...
            <div class="col">
                <nav aria-label="breadcrumb" class=" rounded-3 p-3 mb-4">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active">Danh sách công việc đã đăng</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card border-0 shadow mb-4 p-3">
                    <div class="card-body card-form">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h3 class="fs-4 mb-1">Danh sách công việc đã đăng</h3>
                            </div>
                                ...
                                <tbody class="border-0">
                                    @if ($jobs->isNotEmpty())
                                        @foreach ($jobs as $job)
                                             <tr class="active">
                                        <td>
                                            <a href="{{ route('jobDetail', $job->id) }}"><div class="job-name fw-500">{{ $job->title }}</div></a>
                                            <div class="info1">{{ $job->jobType->name }} . {{ $job->user->companyLocation->name }}</div>
                                        </td>
